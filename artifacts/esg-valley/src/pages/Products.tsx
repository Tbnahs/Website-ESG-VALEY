      ...
      <div className="relative w-full overflow-hidden" style={{ height: "380px" }}>
        ...
        <div className="relative z-10 flex flex-col items-center justify-end h-full pb-8 md:pb-14">
          <div className="flex items-center gap-1.5 mb-3">
            ...
            <span className="font-medium text-white text-base md:text-2xl">Sản phẩm</span>
          </div>
          <h1 className="font-display font-bold text-white text-center text-3xl md:text-5xl" style={{ letterSpacing: "-0.03em" }}>
            Sản Phẩm
          </h1>
        </div>
      </div>
